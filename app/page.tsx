    ...
    <div className="min-h-screen bg-gray-50 text-gray-900 font-sans">
      <header className="bg-blue-900 text-white py-6 px-4 shadow-md">
        <div className="max-w-4xl mx-auto flex flex-col sm:flex-row justify-between items-center">
          <h1 className="text-3xl font-extrabold mb-2 sm:mb-0">TeamX | PunitJakhar</h1>
          <nav className="space-x-4 text-lg">
            <Link href="#home" className="hover:text-blue-300">Home</Link>
            <Link href="#courses" className="hover:text-blue-300">Courses</Link>
            <Link href="#community" className="hover:text-blue-300">Community</Link>
            <Link href="#mentorship" className="hover:text-blue-300">Mentorship</Link>

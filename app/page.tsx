...
export default function HomePage() {
  return (
    <div className="min-h-screen bg-gray-50 text-gray-900 font-sans scroll-smooth">
      <header className="bg-blue-900 text-white py-6 px-4 shadow-md sticky top-0 z-50">
        <div className="max-w-4xl mx-auto flex flex-col sm:flex-row justify-between items-center">
          ...
          <nav className="space-x-4 text-lg">
            ...
            <Link href="#mentorship" className="hover:text-blue-300 transition">Mentorship</Link>

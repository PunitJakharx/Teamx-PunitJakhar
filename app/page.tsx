// pages/index.tsx import Image from 'next/image'; import Head from 'next/head'; import { useEffect } from 'react'; import AOS from 'aos'; import 'aos/dist/aos.css';

export default function Home() { useEffect(() => { AOS.init({ duration: 1000 });
...
{/* Header */}
  ...
  <section style={{
    textAlign: 'center',
    padding: '80px 20px',
    background: `linear-gradient(rgba(0,0,0,0.75), rgba(0,0,0,0.75)), url('/bg-trading.jpg') center/cover no-repeat`,
    color: '#fff',
    position: 'relative'
  }}>
    <h2 style={{
